...
namespace Skilly.Persistence.Migrations
{
    ...
    [Migration("20250625030251_add-review")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Skilly.Core.Entities.Payment", b =>
                {
                    ...
                    b.Property<string>("InstapayEmail")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Skilly.Core.Entities.Wallet", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Skilly.Core.Entities.EmergencyRequest", b =>
                {
                    b.HasOne("Skilly.Core.Entities.User", "AssignedProvider")
                        .WithMany()
            ...
            modelBuilder.Entity("Skilly.Core.Entities.Review", b =>
                {
                    b.HasOne("Skilly.Core.Entities.User", "ServiceProvider")
                        .WithMany()
                        .HasForeignKey("ProviderId");

                    b.HasOne("Skilly.Core.Entities.ServiceProvider", null)
                        .WithMany("Reviews")
                        .HasForeignKey("ServiceProviderId");
            ...
            modelBuilder.Entity("Skilly.Core.Entities.Wallet", b =>
                {
                    b.HasOne("Skilly.Core.Entities.User", "provider")
                        .WithMany()
                        .HasForeignKey("ProviderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
